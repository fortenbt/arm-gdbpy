...
class PageTables(gdb.Command):
    ...
    def _handle_l1_coarse(self, anInt, inf, l1, ttb_index):
        ...
        for i in xrange(256):
            ...
            if l2 & 0x3 == L2_DESCRIPTOR_LARGE:
                self._handle_large_page(ttb_index, l2, i*4)
            elif l2 & 0x3 == L2_DESCRIPTOR_SMALL:
                self._handle_small_page(ttb_index, l2, i*4)
            elif l2 & 0x3 == L2_DESCRIPTOR_TINY:
                self._handle_tiny_page(ttb_index, l2, i*4)
            else:
    ...
    def _dump_page_tables(self, fname, ttb):
        ...
        for i in xrange(4096):
            ...
            if l1 & 0x3 == L1_DESCRIPTOR_COARSE:
                self._handle_l1_coarse(anInt, inf, l1, i*4)
            elif l1 & 0x3 == L1_DESCRIPTOR_SECTION:
                self._handle_l1_section(anInt, inf, l1, i*4)
            elif l1 & 0x3 == L1_DESCRIPTOR_FINE:
                self._handle_l1_fine(anInt, inf, l1, i*4)
            else:
